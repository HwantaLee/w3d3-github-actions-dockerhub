...
## 수업 목표
- 5주 과정의 큰 흐름을 컴퓨팅 기본기에서 Cloud Native 운영까지 연결해 설명한다.
- Week 1의 process, file, port, log, README가 Week 2~5의 Docker, MSA, Kubernetes, AWS, Terraform으로 확장되는 방식을 분석한다.
...
| 14:05~14:15 | 5주 전체 그림 제시 | 각 기술이 따로 떨어진 과목이 아니라 운영 문제의 확장임을 보여준다. |
| 14:15~14:27 | Week 1 spine 설명 | process, file, port, config, log, README를 기준축으로 잡는다. |
| 14:27~14:40 | Week 2~5 기술 연결 | Docker/MSA/Kubernetes/AWS/Terraform을 "무엇을 표준화하는가"로 설명한다. |
...
### Visual 1: 5주 학습 로드맵
![Cloud Native 5-week roadmap](./assets/lesson-02-roadmap.png)

이 이미지는 5주 과정의 큰 방향을 기억하기 위한 개념도다. 제품 로고나 세부 기능을 외우는 용도가 아니라, 각 주차가 어떤 운영 문제를 해결하는지 보는 자료다.

## 14:05~14:15 5주 전체 그림 제시
...
### 활동: 기대/불안 매핑
1. 학생은 5주 표를 보고 각 Week마다 `기대 1개`와 `불안 1개`를 적는다.
...
### 안내 프롬프트
- 공개 질문: "5주 과정에서 가장 먼저 안정화해야 할 내 학습 위험은 무엇인가?"
...
### 세션 체크리스트
- [ ] 학생이 Week 1 spine과 Week 2~5 기술의 연결을 말할 수 있다.
