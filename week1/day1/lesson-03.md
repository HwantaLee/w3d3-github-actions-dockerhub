...
| 15:50~16:00 | 휴식 및 다음 세션 전환 | 50분 수업 후 데이터센터와 클라우드 비교 세션으로 전환한다. |
...
![AI app to business service boundary](./assets/lesson-03-ai-service-boundary.png)
...
- 초점: 50분 수업 후 데이터센터와 클라우드 비교 세션으로 전환한다.
...
### 다음 연결
다음 세션은 데이터센터와 클라우드를 비교하며 운영 책임이 어디로 이동하는지 정리한다.
