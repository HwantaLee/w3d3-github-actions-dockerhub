# 1교시: image와 layer, tag, digest

![Day 3 Image Build Registry overview](./assets/day3-image-build-registry-overview.png)
...
## 강의 전개
pull한 image를 images/history/inspect로 읽고 tag와 digest 차이를 설명한다.
