...
| Docker Desktop Linux install docs | Linux Desktop이 자체 Linux VM과 Docker context를 사용할 수 있고, host Engine과 port 충돌이 날 수 있음을 확인한다. |
| Docker Engine Ubuntu install docs | Linux에서 Desktop 대신 Engine을 설치하는 경로와 daemon 기반 실행을 확인한다. |
