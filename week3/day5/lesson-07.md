...
## 수업 목표
- `샘플앱 내부 통신과 rollout 맛보기`를 운영 시나리오와 연결해 설명한다.
...
## 핵심 설명
service DNS, curlbox, image tag 변경, rollout status/undo를 한 흐름으로 확인하는 것이 이 교시의 핵심이다.
...
## Evidence Note
```markdown
# Week 3 Day 5 Lesson 7 Evidence

## Topic
- Lesson: 샘플앱 내부 통신과 rollout 맛보기
- Goal:
