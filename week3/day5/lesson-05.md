...
## 수업 목표
- `Deployment manifest 구조와 배포`를 운영 시나리오와 연결해 설명한다.
...
## 핵심 설명
apiVersion, kind, metadata, spec, selector, template을 실제 배포 결과와 연결하는 것이 이 교시의 핵심이다.
...
## Evidence Note
```markdown
# Week 3 Day 5 Lesson 5 Evidence

## Topic
- Lesson: Deployment manifest 구조와 배포
- Goal:
