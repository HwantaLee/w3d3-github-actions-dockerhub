...
## 수업 목표
- `Deployment가 필요한 이유`를 운영 시나리오와 연결해 설명한다.
...
## 핵심 설명
Pod 직접 실행의 한계, desired state, replica, self-healing을 확인하는 것이 이 교시의 핵심이다.
...
## Evidence Note
```markdown
# Week 3 Day 5 Lesson 4 Evidence

## Topic
- Lesson: Deployment가 필요한 이유
- Goal:
