...
## 수업 목표
- `GitHub Actions CI gate`를 운영 시나리오와 연결해 설명한다.
...
## 핵심 설명
pull_request event, checkout, lint/test/build, runner, secret evidence를 남기는 것이 이 교시의 핵심이다. 명령을 외우는 것보다 어떤 상태를 확인하려고 그 명령을 실행하는지 말할 수 있어야 한다.
...
## Evidence Note
```markdown
# Week 3 Day 3 Lesson 7 Evidence

## Topic
- Lesson: GitHub Actions CI gate
- Goal:
