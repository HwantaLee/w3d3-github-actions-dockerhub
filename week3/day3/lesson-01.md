# 1교시: Day2 10분 요약 + GitHub 협업 모델

## 수업 목표
- local branch, remote branch, origin, pull request 흐름를 배포 사고 예방 관점으로 설명한다.
- Git 명령을 이력 상태 확인과 연결한다.
- 실패했을 때 되돌리기 기준을 말한다.

## 핵심 설명
local branch와 remote branch를 구분하고 PR이 왜 배포 전 검문소인지 설명한다.
