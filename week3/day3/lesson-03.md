...
## 핵심 설명
작은 PR, reviewer, status check, protected branch evidence를 남기는 것이 이 교시의 핵심이다. 명령을 외우는 것보다 어떤 상태를 확인하려고 그 명령을 실행하는지 말할 수 있어야 한다.
...
## Evidence Note
```markdown
# Week 3 Day 3 Lesson 3 Evidence
