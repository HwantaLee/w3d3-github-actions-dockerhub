...
## 수업 목표
- `구름 EXP 배움일기`를 운영 시나리오와 연결해 설명한다.
...
## 핵심 설명
branch 전략, PR gate, merge/rebase/revert/tag, CI 실패 증거 정리를 남기는 것이 이 교시의 핵심이다. 명령을 외우는 것보다 어떤 상태를 확인하려고 그 명령을 실행하는지 말할 수 있어야 한다.
...
## Evidence Note
```markdown
# Week 3 Day 3 Lesson 8 Evidence
