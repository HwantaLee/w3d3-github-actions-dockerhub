# 4교시: merge/rebase/conflict

## 수업 목표
- `merge/rebase/conflict`를 운영 시나리오와 연결해 설명한다.
...
## 핵심 설명
merge commit, squash, rebase merge 차이와 conflict 재검증 evidence를 남기는 것이 이 교시의 핵심이다. 명령을 외우는 것보다 어떤 상태를 확인하려고 그 명령을 실행하는지 말할 수 있어야 한다.
...
## Evidence Note
```markdown
# Week 3 Day 3 Lesson 4 Evidence

## Topic
- Lesson: merge/rebase/conflict
- Goal:
