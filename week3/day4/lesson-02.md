...
## 수업 목표
- `Kubernetes 핵심 컨셉`을 운영 시나리오와 연결해 설명한다.
...
## 핵심 설명
cluster, node, control plane, worker node, kubelet, container runtime의 역할을 구분하는 것이 이 교시의 핵심이다.
...
## Evidence Note
```markdown
# Week 3 Day 4 Lesson 2 Evidence

## Topic
- Lesson: Kubernetes 핵심 컨셉
- Goal:
