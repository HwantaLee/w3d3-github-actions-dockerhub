# 7교시: WSL/macOS kind 설치

## 수업 목표
- `WSL/macOS kind 설치`를 운영 시나리오와 연결해 설명한다.
...
## 핵심 설명
WSL과 macOS에서 Docker, kubectl, kind 설치와 version 확인 결과를 남기는 것이 이 교시의 핵심이다.
...
## Evidence Note
```markdown
# Week 3 Day 4 Lesson 7 Evidence

## Topic
- Lesson: WSL/macOS kind 설치
- Goal:
