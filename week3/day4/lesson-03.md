...
## 수업 목표
- `Kubernetes가 많이 쓰이는 이유`를 운영 시나리오와 연결해 설명한다.
...
## 핵심 설명
선언적 운영, self-healing, service discovery, rollout/rollback, 확장성이 왜 현업에서 중요한지 설명하는 것이 이 교시의 핵심이다.
...
## Evidence Note
```markdown
# Week 3 Day 4 Lesson 3 Evidence

## Topic
- Lesson: Kubernetes가 많이 쓰이는 이유
- Goal:
