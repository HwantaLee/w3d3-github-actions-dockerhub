...
## 수업 목표
- `많이 쓰이는 분야와 참고 사례`를 운영 시나리오와 연결해 설명한다.
...
## 핵심 설명
MSA, SaaS, platform engineering, CI/CD, managed Kubernetes, edge/k3s 사례를 Kubernetes 도입 이유와 연결하는 것이 이 교시의 핵심이다.
...
## Evidence Note
```markdown
# Week 3 Day 4 Lesson 5 Evidence

## Topic
- Lesson: 많이 쓰이는 분야와 참고 사례
- Goal:
