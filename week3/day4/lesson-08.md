...
## 수업 목표
- `kind cluster 생성과 확인`을 운영 시나리오와 연결해 설명한다.
...
## 핵심 설명
`kind create cluster`, kubectl context, node, cluster-info 확인 결과를 남기는 것이 이 교시의 핵심이다.
...
## Evidence Note
```markdown
# Week 3 Day 4 Lesson 8 Evidence

## Topic
- Lesson: kind cluster 생성과 확인
- Goal:
