# 1교시: Kubernetes가 등장한 배경

## 수업 목표
- `Kubernetes가 등장한 배경`을 운영 시나리오와 연결해 설명한다.
...
## 핵심 설명
컨테이너 수 증가, 배포 반복, 장애 복구, 스케줄링 문제가 Kubernetes로 이어지는 배경을 설명하는 것이 이 교시의 핵심이다.
...
## Evidence Note
```markdown
# Week 3 Day 4 Lesson 1 Evidence

## Topic
- Lesson: Kubernetes가 등장한 배경
- Goal:
